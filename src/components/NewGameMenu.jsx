...
const NewGameMenu = () => {
  ...
  return (
    <div className={"flex flex-col gap-8 sm:gap-10 max-w-115 w-full"}>
      ...
      <div
        className={
          "rounded-sm bg-slate-800 py-6 sm:py-5 px-6 flex flex-col gap-6"
        }
      >
        <h1
          className={
            "uppercase text-slate-300 text-preset-4 leading-preset-4 tracking-preset-4 font-preset-4 text-center"
          }
        >
        ...
        <h2
          className={
            "uppercase text-slate-300 text-preset-5 leading-preset-5 tracking-preset-5 font-preset-5-bold text-center"
          }
        >
